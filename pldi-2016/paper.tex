...
For example, \url{http://openweathermap.org/current} contains one eample to document an end-point 
to get the current weather. Using standard libraries, we might call it as:
...
\ident{Array} for the latter. Second, the the field \ident{value} is \kvd{null} for some records. Third, 
...
\ident{lub}(\nu \; \{ \nu_1 \!:\! \sigma_1,  \ldots \;, \nu_n \!:\! \sigma_n \}, 
  \nu \; \{ \nu'_1 \!:\! \sigma'_1, \; \ldots \;, \nu'_m \!:\! \sigma'_m \}) &=& 
  \nu \; \{ \nu_1 \!:\! \ident{lub}(\sigma_1, \sigma'_1), \; \ldots \; , \nu_k \!:\! \ident{lub}(\sigma_n, \sigma'_n) \}  \\[0.75em]
