\documentclass[10pt,preprint,clearpagebib]{sigplanconf}

\usepackage{listings}
\usepackage{enumitem}
\usepackage[hyphens]{url}
\usepackage[svgnames]{xcolor}
\definecolor{lcl}{RGB}{160,0,128}
\usepackage[colorlinks=true,breaklinks,draft=false]{hyperref}
\hypersetup{urlcolor=lcl,linkcolor=lcl}
...
% T :> S means that S is a subtype of T (and S can be used where T is expected)
% TOP is the universal supertype
% BOTTOM is the universal subtype

% variant is the top type 
%  (variant is a suprtype of everything; everything is a subtype of variant; 
%   everything can be used where variant is expected)
%
% bottom is the bottom type
%  (bottom is a subtype of everything; everything is a supertype of bottom
%   bottom can be used where anything else is expected - but it has no values)
%
% define :=: when <: and :>, then take equivalence classes 

% least upper bound of T1 and T2 is a supertype of both (T :> T1 and T :> T2)
% and for all S such that S :> T1 and S :> T2, it holds that S :> T 
