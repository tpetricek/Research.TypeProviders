...
subsequent formalization, we introduce a \emph{top shape} (\S\ref{?}) and extend it with labels 
capturing the statically known possibilities (\S\ref{?}). The \emph{labelled top shape} is mapped 
...
(Corollary~\ref{thm:no-unions}, \S\ref{sec:impl-hetero}).
