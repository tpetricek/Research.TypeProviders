...
\end{theorem}
\begin{proof}
We discuss the two parts of the proof separately as type prservation (Lemma~\ref{thm:rs-preservation})
...
Mainly because type providers can only provide objects

Unions become records with fields - so hiding null makes sense
also it means the open-world semantics 
