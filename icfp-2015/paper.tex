...
Given samples $s_1, \ldots, s_n$, inferred type $\sigma=\semalt{s_1, \ldots, s_n}$ and generated 
$\tau,e,L = \sem{\sigma}_x$ then:

For all $s'$ such that $\exists i.s_i :> s'$, then for any $e$ such that $x:\ident{StructVal} \vdash e:\tau$
it is the case that $e[x\leftarrow s'] \reduce^{*} v$ and $\vdash v : \tau$.
